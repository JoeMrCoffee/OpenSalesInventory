<?php 
	...
	if ($validity == "valid" && $userlvl == "admin") {
		...
		foreach($userlist as $user){
			...
			if ($usercnt % 2 == 0 && $stylesheet == "light"){
				echo "<tr style='background-color:#eaeaea;'>";
				$usercnt += 1;
			}
			else if ($usercnt % 2 == 0 && $stylesheet == "dark"){
			...
			//Edit user pop-up
			echo "<div class='popupwindow' style='visibility: hidden;' id='$uid'>
				<img class='closepopup' onclick='popupdisplay(\"$uid\")' src='close.png'>
